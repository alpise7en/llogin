...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom">GEMAS</div>
  ...
  <select id="exfiles" name="exfiles" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
    ...
    <option value="download">Excel Dosyas2</option>
  </select>
  <br /><br />
